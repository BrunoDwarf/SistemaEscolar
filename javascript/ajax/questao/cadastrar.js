...
function checaDados()
{
	...
	var Codigo = document.getElementById("codigo_questao").value;
  var Titulo = document.getElementById("titulo_questao").value;
  var Corpo = document.getElementById("corpo_questao").value;
  var Dificuldade = document.getElementById("dificuldade_questao").value;
	var Ano = document.getElementById("ano_questao").value;
	var params = "Codigo="+Codigo+"&Titulo='"+Titulo+"'&Corpo='"+Corpo+"'&Dificuldade='"+Dificuldade+"'&Ano="+Ano+"";
	...
	xmlreq.open("POST", "../../php/questao/cadastrar.php", true);
