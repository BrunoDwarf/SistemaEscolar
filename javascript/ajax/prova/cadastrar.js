...
function checaDados()
{
	...
	var Codigo = document.getElementById("codigo_prova").value;
  var Titulo = document.getElementById("titulo_prova").value;
  var Cpf = document.getElementById("cpf_professor").value;
  var Disciplina = document.getElementById("disciplina_prova").value;
	var params = "Codigo="+Codigo+"&Titulo='"+Titulo+"'&Cpf='"+Cpf+"'&Disciplina='"+Disciplina+"'";
	...
	xmlreq.open("POST", "../../php/prova/cadastrar.php", true);
