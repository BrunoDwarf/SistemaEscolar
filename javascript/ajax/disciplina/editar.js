...
function editar()
{
	...
	var nome_disciplina_editar = document.getElementById("nome_disciplina_editar").value;
  var nome_disciplina_editar_nova = document.getElementById("nome_disciplina_editar_nova").value;
	var params = "nome_disciplina="+nome_disciplina_editar+"&nome_disciplina_nova="+nome_disciplina_editar_nova+" ";
	...
	xmlreq.open("POST", "../php/action/disciplina_editar.php", true);
