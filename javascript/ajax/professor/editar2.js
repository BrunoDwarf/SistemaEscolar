...
function editar2()
{
  ...
  var nome_professor_editar = document.getElementById("nome_professor_editar").value;
  var idade_professor_editar = document.getElementById("idade_professor_editar").value;
	var params = "cpf_professor="+cpf_professor_editar+"&nome_professor="+nome_professor_editar+"&idade_professor="+idade_professor_editar+" ";
	var result = document.getElementById("status-editar");
	...
	xmlreq.open("POST", "../php/action/professor_editar2.php", true);
