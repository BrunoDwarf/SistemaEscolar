...
function checaDados()
{
	...
	var NumeroQuestao = document.getElementById("numero_questao").value;
	var params = "CodigoProva="+CodigoProva+"&CodigoQuestao="+CodigoQuestao+"&NumeroQuestao="+NumeroQuestao+"";
	...
	xmlreq.open("POST", "../../php/questao_prova/cadastrar.php", true);
