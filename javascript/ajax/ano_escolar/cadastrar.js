...
function cadastrar()
{
	...
	var nome_ano_cadastrar = document.getElementById("nome_ano_cadastrar").value;
	var params = "nome_ano="+nome_ano_cadastrar+" ";
	...
	xmlreq.open("POST", "../php/action/ano_cadastrar.php", true);
