...
function deletar()
{
	...
	var nome_ano_deletar = document.getElementById("nome_ano_deletar").value;
	var params = "nome_ano="+nome_ano_deletar+" ";
	...
	xmlreq.open("POST", "../php/action/ano_deletar.php", true);
