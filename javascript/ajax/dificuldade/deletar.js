...
function deletar()
{
	...
	var nome_dificuldade_deletar = document.getElementById("nome_dificuldade_deletar").value;
	var params = "nome_dificuldade="+nome_dificuldade_deletar+" ";
	...
	xmlreq.open("POST", "../php/action/dificuldade_deletar.php", true);
